			...
			try {
				...
				try {
					...
					try {
						...
						Cipher cifrado = Cipher.getInstance("DES");						// Escojo modo cifrado o descifrado segun sea el caso
						if (comando1.equals(comando1)) {
						...
						textoCifrado = textoCifrado
								+ new String(bloque_cifrado, "ISO-8859-1");							// ISO-8859-1 es ISO-Latin-1
				...
				System.out.println("El temps: " + (System.currentTimeMillis() - temps) + "milisegons");
			}
